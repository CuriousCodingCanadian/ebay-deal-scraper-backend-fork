<script lang="ts">
    ...
    let exclusions: string = ''; // real value defined in onMount
    ...
    onMount(() => {
        ...
        checkboxes.forEach(checkbox => {
            console.log('Checkbox data-id:', checkbox.getAttribute('data-id'));
        });
        ...
        <div id="main-flexbox">
            <div id="sidebar">
                <h1>Filters</h1>
                    ...
                    <div id="listing-type">
                        <label>
                            <input id="auction-checkbox" class="listingtypecheckboxes" type="checkbox" bind:checked={filterAuction} on:change={updateFilter}>
                            Auction
                        </label>
                        <br>
                        <label>
                            <input id="buyitnow-checkbox" class="listingtypecheckboxes" type="checkbox" bind:checked={filterBuyItNow} on:change={updateFilter}>
                            Buy It Now
                        </label>
                    </div>
